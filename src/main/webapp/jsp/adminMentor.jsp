...
<form:form method="POST" action="/listMentor" modelAttribute="mentor">
	...
	%>
	 ...
	 <tr>
        ...
        <% boolean b= mentor.isActive();
boolean a=false;
if(a==b)
{
%>
                                  <td> <a href="/blockmentor?id=<%=mentor.getMentorId()%>" class="btn btn-primary">Block</a></td>
<%}else{ %>

<td><a href="/Unblockmentor?id=<%=mentor.getMentorId()%>" class="mentor btn-primary">UnBlock</a></td>
<%} %>
