...
<body>
<div class="container">
<form:form method="GET" action="/loginVerification" modelAttribute="login" class="loginform">
 
<h2 class="createaccount" >Login</h2>
<br><br>
   <div class="row">
 ...
 <p class="dangermessage"> <span>${message}</span></p>
</div>
</body>
</html>