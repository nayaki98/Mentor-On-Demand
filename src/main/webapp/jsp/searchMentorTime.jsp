...
<div class="container">
<form:form method="GET" action="/getMentorsByTime" modelAttribute="mentor" class="loginform">
 
<h2 class="createaccount" >Search Mentor By Time</h2>
<br><br>
   <div class="row">
            <div class="form-group col-md-12">
   
               <div class="col-md-6 col-md-offset-3">
                    <form:input type="text" path="fromTime" id="fromTime" class="form-control input-sm" placeholder=" Enter Time" />
                    <div class="has-error">
